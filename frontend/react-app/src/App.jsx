...
const topics = {
  'Phase 1: Foundation': [
    { id: 1, name: 'API Calls', days: '1-2' },
    { id: 2, name: 'TanStack Query', days: '3-4' },
    { id: 3, name: 'Debounce & Throttle', days: '5-6' },
    { id: 4, name: 'Pagination & Virtual Scroll', days: '7-8' },
    { id: 5, name: 'Filtering & Sorting', days: '9-10' },
    { id: 6, name: 'Forms & Validation', days: '11-12' },
    { id: 7, name: 'File Uploads & Progress', days: '13-14' },
  ],
  'Phase 2: State & App Flow': [
    { id: 8, name: 'Redux Toolkit', days: '15-16' },
    { id: 9, name: 'Authentication & JWT', days: '17-18' },
    { id: 10, name: 'RBAC', days: '19-20' },
    { id: 11, name: 'SQL Joins & Normalization', days: '21-22' },
    { id: 12, name: 'N+1 Query Problem', days: '23-24' },
    { id: 13, name: 'Expensive Queries & Indexing', days: '25-26' },
    { id: 14, name: 'Transactions & ACID', days: '27-28' },
    { id: 15, name: 'Caching & Connection Pooling', days: '29-30' },
  ],
  'Phase 3: Real-time & Reliability': [
    { id: 16, name: 'WebSockets', days: '31-32' },
    { id: 17, name: 'Server-Sent Events', days: '33-34' },
    { id: 18, name: 'Optimistic UI Updates', days: '35-36' },
    { id: 19, name: 'Error Handling & Resilience', days: '37-38' },
    { id: 20, name: 'Rate Limiting', days: '39-40' },
    { id: 21, name: 'API Versioning', days: '41-42' },
  ],
  'Phase 4: Architecture Thinking': [
    { id: 22, name: 'Event-Driven Architecture', days: '43-44' },
    { id: 23, name: 'Microservices', days: '45-46' },
    { id: 24, name: 'API Gateway Pattern', days: '47-48' },
    { id: 25, name: 'Monorepo vs Multi-repo', days: '49-50' },
  ],
}
...
function App() {
  ...
  const checkAPIStatus = async () => {
    try {
      ...
      try {
        const pythonResponse = await axios.get('http://localhost:8000/api/health')
        setApiStatus({
          status: 'connected',
          backend: 'Python',
          port: 8000
            ...
            <section key={phase} className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {phaseTopics.map((topic) => (
                  <div
                    key={topic.id}
                    className="p-4 bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg border border-gray-200 hover:border-blue-400 hover:shadow-md transition cursor-pointer group"
                  >
